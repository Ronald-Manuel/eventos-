...
import com.ronaldmanuel.SessionBeans.CotizacionFacadeLocal;
...
public class CotizacionController implements Serializable {
    ...
    @EJB
    private com.ronaldmanuel.SessionBeans.CotizacionFacadeLocal  ejbFacade;
    ...
    private CotizacionFacadeLocal getFacade() {
        return ejbFacade;
    }
    ...
    public static class CotizacionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Cotizacion) {
                ...
                return getStringKey(o.getIdcotizacion());
            } else {
